...
From the figure 2 of [Campos et al., 2017](https://doi.org/10.1016/j.agwat.2017.03.022) we deduced the equation $Kc = 1.1*(1-e^{-(\frac{GDD}{620})^3})+0.1$. This Crop coefficient was use to get the Potential Transpiration of a standard Maize field. $T_{pot} = Kc * ET_0$.
